    ...
    <div class="app">
        <aside class="sidebar">
            ...
            <nav class="nav">
                ...
                <button id="nav-logout" style="margin-top:18px">Logout</button>
            </nav>
            <div style="margin-top:18px;font-size:12px;color:var(--muted)">Connected to MySQL via api.php</div>
        </aside>

        <main class="main">
            <header class="topbar">
                <div class="top-left">Customer Satisfaction — Admin</div>
                <div style="color:var(--muted);font-size:13px;">Signed in as <strong>Admin</strong></div>
            </header>
